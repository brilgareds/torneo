...
<div id="wrapper">
  ...
  <div id="menu" class="menu opacity">
    <ul>
      <li><a href="index_pro.php">Inicio</a></li>
      <li><a href="subir_eventos.php">Eventos</a></li>
      <li><a href="subir_alumnos.php">Alumno</a></li>
      <li><a href="subir_profesores.php">Profesores</a></li>
      <li><a href="subir_notas.php">Notas</a></li>
      <li><a href="subir_horarios.php">Horarios</a></li>
  ...
  <h3 align="rigth">Hola <b><?php
echo $_SESSION['nombre'];
?>
 </b>(^_^)<br align"center"><br>
Gracias por iniciar sesion.!<br>
Selecciona en el menu superior que deseas hacer.!<br><br>
Tu cedula es: <b>
<?php
